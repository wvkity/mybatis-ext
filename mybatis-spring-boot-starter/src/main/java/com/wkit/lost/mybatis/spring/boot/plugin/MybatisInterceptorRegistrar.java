...
import com.wkit.lost.mybatis.spring.boot.plugin.config.AnnotationInterceptorConfiguration;
import com.wkit.lost.mybatis.spring.boot.plugin.config.InterceptorConfiguration;
import com.wkit.lost.mybatis.spring.boot.plugin.config.InterceptorDefinition;
