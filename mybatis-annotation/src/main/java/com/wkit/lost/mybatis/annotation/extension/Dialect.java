...
public enum Dialect {
    ...
    static {
        ...
        DATABASE_JDBC_CACHE.put( "jdbc:sqlserver:", SQLSERVER2005 );
        DATABASE_JDBC_CACHE.put( "jdbc:microsoft:", SQLSERVER2005 );
        DATABASE_JDBC_CACHE.put( "jdbc:sqlserver2012:", SQLSERVER );
        DATABASE_JDBC_CACHE.put( "jdbc:postgresql:", POSTGRE );
        DATABASE_JDBC_CACHE.put( "jdbc:log4jdbc:postgresql:", POSTGRE );
        DATABASE_JDBC_CACHE.put( "jdbc:hsqldb:", HSQL );
        DATABASE_JDBC_CACHE.put( "jdbc:log4jdbc:hsqldb:", HSQL );
