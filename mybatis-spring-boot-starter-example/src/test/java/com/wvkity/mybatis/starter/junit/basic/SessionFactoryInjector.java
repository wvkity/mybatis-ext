...
public class SessionFactoryInjector extends RootTestRunner {
    ...
    public void test1() {
        ...
        log.info("{}", com.wvkity.mybatis.starter.junit.inject.TestApp.class.toString());
        log.info("{}", com.wvkity.mybatis.starter.junit.inject.TestApp.class.getCanonicalName());
    }
}
