    ...
    companion object {
        ...
        fun loadConnectConfigList(): MutableList<ConnectionConfig> {
            ...
            if (list != null && list.isNotEmpty()) {
                list.forEach { result.add(transform(it)) }
            }
            return result
        }
        ...
        fun update(connect: ConnectionConfigInfo) {
            JdbcTemplate.update(getConnection(), CONNECT_CONFIG_UPDATE_SQL, connect.connectName, connect.connectValue,
