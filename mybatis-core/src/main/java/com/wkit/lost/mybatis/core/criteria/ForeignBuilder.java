 ...
 * @param <P>       Lambda属性对象
 */
public interface ForeignBuilder<T, Context, P> extends LambdaConverter<P> {
     ...
     * @return 联表条件对象
     */
    default <E> ForeignCriteria<E> createForeign( Class<E> entity, String alias, P master,
