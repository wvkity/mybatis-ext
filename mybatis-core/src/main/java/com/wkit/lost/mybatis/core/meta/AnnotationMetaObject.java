...
public class AnnotationMetaObject {
    ...
    public static AnnotationMetaObject forObject( Class<?> clazz, String annotationClass ) {
        return AnnotationUtil.getAnnotationMetaObject( clazz, annotationClass );
    }

    public static AnnotationMetaObject forObject( Field field, String annotationClass ) {
