...
public class NotEqual<T> extends Simple<T> {
     ...
     * @return 条件对象
     */
    public static <T, V> NotEqual<T> create(Criteria<T> criteria, Property<T, V> property, V value) {
     ...
     * @return 条件对象
     */
    public static <T, V> NotEqual<T> create(Criteria<T> criteria, Property<T, V> property, V value, Logic logic) {
