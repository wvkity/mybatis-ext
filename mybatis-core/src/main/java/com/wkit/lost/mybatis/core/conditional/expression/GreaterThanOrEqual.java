...
public class GreaterThanOrEqual<T> extends Simple<T> {
     ...
     * @return 条件对象
     */
    public static <T> GreaterThanOrEqual<T> create( Criteria<T> criteria, Property<T, ?> property, Object value ) {
     ...
     * @return 条件对象
     */
    public static <T> GreaterThanOrEqual<T> create( Criteria<T> criteria, Property<T, ?> property, Object value, Logic logic ) {
     ...
     * @return 条件对象
     */
    public static <T> GreaterThanOrEqual<T> create( Criteria<T> criteria, ColumnWrapper column, Object value, Logic logic ) {
