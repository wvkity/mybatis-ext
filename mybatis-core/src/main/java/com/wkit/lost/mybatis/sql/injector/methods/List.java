...
import com.wkit.lost.mybatis.sql.mapping.query.ListSqlBuilder;
...
public class List extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement( Class<?> mapperInterface, Class<?> resultType, Table table ) {
        ...
        DefaultXmlScriptBuilder scriptBuilder = new DefaultXmlScriptBuilder( entity, table.getAlias(), table, new ListSqlBuilder() );
