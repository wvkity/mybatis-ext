...
public class LessThan<T> extends Simple<T> {
     ...
     * @return 条件对象
     */
    public static <T, V> LessThan<T> create(Criteria<T> criteria, Property<T, V> property, V value) {
     ...
     * @return 条件对象
     */
    public static <T, V> LessThan<T> create(Criteria<T> criteria, Property<T, V> property, V value, Logic logic) {
