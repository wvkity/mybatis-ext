...
import com.wkit.lost.mybatis.sql.mapping.AbstractLogicalDeletionSqlBuilder;
...
public class LogicDeleteSqlBuilder extends AbstractLogicalDeletionSqlBuilder {
    ...
    public String build() {
        ...
        String condition = "<where>" +
                columns.stream().map( column -> convertToIfTagOfNotNull( true, Execute.REPLACE, false, 0, Constants.PARAM_ENTITY, column, null, AND ) )
