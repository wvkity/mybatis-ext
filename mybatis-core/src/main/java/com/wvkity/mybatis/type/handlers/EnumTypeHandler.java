 ...
 */
@Log4j2
public class EnumTypeHandler<E extends Enum<E> & EnumSupport<E, T>, T> extends BaseTypeHandler<EnumSupport<E, T>> {
    ...
    @Override
    public EnumSupport<E, T> getNullableResult(ResultSet rs, String columnName) throws SQLException {
    ...
    @Override
    public EnumSupport<E, T> getNullableResult(ResultSet rs, int columnIndex) throws SQLException {
    ...
    @Override
    public EnumSupport<E, T> getNullableResult(CallableStatement cs, int columnIndex) throws SQLException {
