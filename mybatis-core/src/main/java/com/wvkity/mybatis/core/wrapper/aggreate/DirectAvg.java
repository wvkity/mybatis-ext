 ...
 * @author wvkity
 */
public class DirectAvg extends AbstractDirectFunction {

    private static final long serialVersionUID = -1816963280007028385L;
     ...
     * @param logic      逻辑符号
     */
    public DirectAvg(Criteria<?> criteria, String tableAlias, String column, boolean distinct,
