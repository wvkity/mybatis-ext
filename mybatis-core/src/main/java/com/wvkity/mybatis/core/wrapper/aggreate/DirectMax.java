 ...
 * @author wvkity
 */
public class DirectMax extends AbstractDirectFunction {

    private static final long serialVersionUID = 4665133613091261530L;
     ...
     * @param logic      逻辑符号
     */
    public DirectMax(Criteria<?> criteria, String tableAlias, String column, boolean distinct,
