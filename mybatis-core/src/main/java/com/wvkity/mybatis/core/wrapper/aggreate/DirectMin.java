 ...
 * @author wvkity
 */
public class DirectMin extends AbstractDirectFunction {

    private static final long serialVersionUID = 813233276061162356L;
     ...
     * @param logic      逻辑符号
     */
    public DirectMin(Criteria<?> criteria, String tableAlias, String column, boolean distinct,
