 ...
 * @author wvkity
 */
public class Max extends AbstractColumnFunction {

    private static final long serialVersionUID = 7260461188618912407L;
     ...
     * @param logic      逻辑符号
     */
    public Max(Criteria<?> criteria, ColumnWrapper column, boolean distinct, Integer scale, String alias,
