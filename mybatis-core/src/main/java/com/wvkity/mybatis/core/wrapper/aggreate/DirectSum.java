 ...
 * @author wvkity
 */
public class DirectSum extends AbstractDirectFunction {

    private static final long serialVersionUID = 5447363259710266337L;
     ...
     * @param logic      逻辑符号
     */
    public DirectSum(Criteria<?> criteria, String tableAlias, String column, boolean distinct,
