 ...
 * @author wvkity
 */
public class Sum extends AbstractColumnFunction {

    private static final long serialVersionUID = -5272205982069617696L;
     ...
     * @param logic      逻辑符号
     */
    public Sum(Criteria<?> criteria, ColumnWrapper column, boolean distinct, Integer scale, String alias,
