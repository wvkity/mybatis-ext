 ...
 * @author wvkity
 */
public class Avg extends AbstractColumnFunction {

    private static final long serialVersionUID = 8032113378489115392L;
     ...
     * @param logic      逻辑符号
     */
    public Avg(Criteria<?> criteria, ColumnWrapper column, boolean distinct, Integer scale, String alias,
